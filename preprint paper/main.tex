...
This overlap supports the model's validity: coalitions flagged as potentially influential by our tipping score framework are not only plausible but often reflect known diplomatic groupings that have, in fact, shaped global policy outcomes. \paragraph{Limitations and Next Steps.}
