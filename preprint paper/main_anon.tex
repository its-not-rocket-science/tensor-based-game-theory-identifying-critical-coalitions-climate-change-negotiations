...
Blinded for review. All analysis code and output data are available at the project repository (link provided upon acceptance).

\smallskip
\noindent\textbf{Generative AI disclosure.} Large language model assistance was used during code development and manuscript editing. All mathematical derivations, empirical results, and interpretive claims were produced and verified by the author.
